<template>
  <aside :style="{
    ...
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:28px;padding-left:2px;flex-shrink:0">
      ...
      <span v-if="open" style="font-size:0.92rem;font-weight:600;color:#e4e6f4;white-space:nowrap">Arabel Learn</span>
    </div>
  ...
  <Teleport to="body">
    ...
    <Transition name="user-menu">
      <div v-if="menuOpen" :style="{
        ...
        <button @click="goProfile" class="menu-item">
...
const icons = {
  profile: '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>',
